...
| Tier        | Tên gợi ý       | Mô tả hình ảnh (Visual description)                                            | Hình ảnh minh họa                        | Ghi chú            |
| :---------- | :-------------- | :----------------------------------------------------------------------------- | :--------------------------------------- | :----------------- |
| **Tier 1**  | Cây gậy gỗ      | Một cành cây khô, hoặc thanh gỗ vuông đơn giản, có dằm.                        | ![Gậy gỗ](./images/equip_gay_go.png)     | Làm trước bản demo |
| **Tier 2**  | Cục gạch        | Viên gạch ống màu đỏ cam, bị mẻ một góc.                                       | ![Cục gạch](./images/equip_cuc_gach.png) | Làm trước bản demo |
| **Tier 3**  | Dép lào         | Chiếc dép xốp cao su màu xanh/vàng quen thuộc.                                 |                                          | Làm trước bản demo |
| **Tier 4**  | Cờ lê rỉ sét    | Cây cờ lê kim loại cũ kỹ, có vết rỉ sét màu nâu.                               |                                          | Làm trước bản demo |
...
| Tier        | Tên gợi ý          | Mô tả hình ảnh                                             | Ghi chú            |
| :---------- | :----------------- | :--------------------------------------------------------- | :----------------- |
| **Tier 1**  | Áo ba lỗ cháo lòng | Áo thun ba lỗ màu trắng ngà, có vết ố, rách lỗ nhỏ.        | Làm trước bản demo |
| **Tier 2**  | Áo mưa nilon       | Áo mưa giấy mỏng manh nhiều màu (xanh/đỏ/tím).             | Làm trước bản demo |
| **Tier 3**  | Tấm bìa carton     | Hai tấm bìa carton trước sau nối bằng dây thừng.           | Làm trước bản demo |
| **Tier 4**  | Áo phao            | Áo phao cứu sinh màu cam nổi bật.                          | Làm trước bản demo |
...
| Tier        | Tên gợi ý            | Mô tả hình ảnh                                           | Ghi chú            |
| :---------- | :------------------- | :------------------------------------------------------- | :----------------- |
| **Tier 1**  | Chân đất             | Không có icon giày, chỉ vẽ bàn chân bẩn.                 | Làm trước bản demo |
| **Tier 2**  | Dép tổ ong           | Huyền thoại dép tổ ong màu trắng ngà hoặc vàng.          | Làm trước bản demo |
| **Tier 3**  | Dép xỏ ngón          | Dép lào xỏ ngón đi biển.                                 | Làm trước bản demo |
| **Tier 4**  | Giày vải thượng đình | Giày vải bata trắng sọc xanh quốc dân.                   | Làm trước bản demo |
...
| Tier        | Tên gợi ý           | Mô tả hình ảnh                         | Ghi chú            |
| :---------- | :------------------ | :------------------------------------- | :----------------- |
| **Tier 1**  | Dây thừng           | Một sợi dây thừng buộc cổ.             | Làm trước bản demo |
| **Tier 2**  | Khăn quàng đỏ       | Khăn quàng học sinh tiểu học.          | Làm trước bản demo |
| **Tier 3**  | Huy chương bé ngoan | Huy chương nhựa mẫu giáo.              | Làm trước bản demo |
| **Tier 4**  | Còi trọng tài       | Cái còi nhựa đeo cổ.                   | Làm trước bản demo |
