...
| Nhân vật           | Kỹ năng                   | VFX Mô tả                                                                                                                              | SFX Mô tả                                                |
| :----------------- | :------------------------ | :------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------- |
| **Chị tạp vụ**     | **Active: Lau sàn**       | Lướt tới (Dash) để lại vệt nước xà phòng đầy bọt. Địch trúng chiêu có hiệu ứng "ngôi sao xoay tròn" trên đầu (Stun).                   | Tiếng trượt ngã "Oạch!". Tiếng nước lau sàn "Chèm chẹp". |
|                    | **Passive: Sàn trơn**     | Vũng nước nhỏ dưới chân địch khi chúng tấn công chị.                                                                                   | Tiếng trượt chân "Vút... Ầm".                            |
| **Anh Grab Food**  | **Active: Giao tốc hành** | Ném một hộp xốp trắng/hộp giấy. Khi chạm đất nổ ra cơm, canh, đùi gà tung tóe.                                                         | Tiếng xe máy rồ ga "Vù vù". Tiếng hộp rơi "Bộp".         |
|                    | **Passive: Đúng giờ**     | Hiệu ứng gió (Wind lines) speed line sau lưng khi chạy.                                                                                | Tiếng đồng hồ bấm giờ "Tít tít".                         |
...
| Nhân vật             | Kỹ năng                      | VFX Mô tả                                                                                                  | SFX Mô tả                                                  |
| :------------------- | :--------------------------- | :--------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------- |
| **Chú Ba xe ôm**     | **Active: Đón khách**        | Triệu hồi chiếc Dream chiến lao tới húc tung địch. Khói bô xe xả mù mịt đen sì.                            | Tiếng còi xe "Bíp bíp". Tiếng động cơ xe cũ "Phạch phạch". |
|                      | **Passive: Vượt đèn đỏ**     | Khi bị slow, có icon biển báo cấm hiện ra và bị gạch chéo (phá luật).                                      | Tiếng ruy ga vượt chốt.                                    |
| **Cô Tư bán nước**   | **Active: Trà đá**           | Cô Tư tạt một ca nước chè lớn vào cả team. Đồng đội ướt sũng nhưng phát sáng (Hồi Energy).                 | Tiếng nước tạt "Ào". Tiếng đá lanh canh trong cốc.         |
|                      | **Passive: Chém gió**        | Gió nhẹ thổi bay tóc đồng đội đứng cạnh.                                                                   | Tiếng gió hiu hiu.                                         |
...
| Nhân vật                | Kỹ năng                | VFX Mô tả                                                                                                              | SFX Mô tả                                                     |
| :---------------------- | :--------------------- | :--------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------ |
| **Tổ trưởng dân phố**   | **Active: Loa phường** | Cầm loa hét, sóng âm cực mạnh (sound wave distortion) làm rung chuyển không gian xung quanh.                           | Tiếng loa rè rè đặc trưng + Tiếng thông báo dõng dạc.         |
|                         | **Passive: Uy tín**    | Hào quang ngôi sao vàng 5 cánh tỏa ra dưới chân.                                                                       | -                                                             |
| **Thợ cắt tóc**         | **Active: Múa kéo**    | Di chuyển siêu nhanh (tàn ảnh), để lại các vết cắt chéo (X-slash) màu bạc trên người địch. Máu phun ra (pixel art).    | Tiếng kéo cắt cực nhanh "Xoẹt xoẹt xoẹt".                     |
|                         | **Passive: Tút tát**   | Sau khi giết địch, vuốt tóc, có hiệu ứng "Bling chling" (lấp lánh).                                                    | Tiếng vuốt tóc.                                               |
...
| Nhân vật           | Kỹ năng                      | VFX Mô tả                                                                                                                   | SFX Mô tả                                  |
| :----------------- | :--------------------------- | :-------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------- |
| **Vua cờ bạc**     | **Active: Thần bài**         | Ném 3 lá bài xoay tít. <br/> - **Xanh:** Hào quang hồi mana. <br/> - **Đỏ:** Nổ lửa. <br/> - **Vàng:** Tia sét giật choáng. | Tiếng xào bài "Xoạt xoạt". Tiếng nổ combo. |
|                    | **Passive: Gian lận**        | Thi thoảng lén lút rút bài từ ống tay áo (animation nhỏ).                                                                   | Tiếng cười nham hiểm.                      |
| **Đại ca khu phố** | **Active: Triệu hồi đàn em** | Hú còi, 2 xe máy chở đệ tử phóng ra chiến đấu.                                                                              | Tiếng còi hú. Tiếng "Anh em ơi!".          |
|                    | **Passive: Bảo kê**          | Có sợi dây liên kết mờ (Link) giữa Đại ca và Đệ tử.                                                                         | -                                          |
