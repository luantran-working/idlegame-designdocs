...
| Tên nhân vật       | Visual concept                                                                                                               | Animation                                                                    | Audio specs                                                                       | Hình ảnh mô phỏng                              | Ghi chú            |
| :----------------- | :--------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------- | :-------------------------------------------------------------------------------- | :--------------------------------------------- | :----------------- |
| **Đại ca khu phố** | Đàn ông 40 tuổi, to béo, bụng phệ, cởi trần khoe hình xăm "Nhẫn", đeo dây chuyền vàng, kính râm đen. Cầm phóng lợn.          | Dáng đi khệnh khạng ưỡn ngực. Skill: Giơ tay gọi đệ chạy ra từ 2 bên.        | **Call:** "Anh em đâu!", "Xử nó!" <br/> **Skill:** Tiếng huýt sáo chói tai.       | ![Đại ca khu phố](./images/dai_ca_khu_pho.png) | Làm trước bản demo |
| **Vua cờ bạc**     | Nam, mặc vest trắng nhàu nát, tóc vuốt keo bóng lộn, mắt thâm quầng. Tay cầm bộ bài xòe ra.                                  | Phi lá bài như ninja. Skill: Tung bộ bài lên trời rơi xuống như mưa.         | **Atk:** Tiếng bài bay "Vút vút" <br/> **Skill:** "Tất tay nhé!", "Khô máu luôn!" | ![Vua cờ bạc](./images/vua_co_bac.png)         | Làm trước bản demo |
...
| **Tiến sĩ giấy**   | Ông già gầy gò, áo cử nhân thùng thình, mũ tốt nghiệp, kính cận dày. Ôm chồng sách cao quá đầu.                              | Đi loạng choạng sắp ngã. Skill: Vấp ngã làm rơi sách tỏa sáng buff đồng đội. | **Skill:** "Học, học nữa, học mãi!" <br/> **Die:** "Rớtt môn rồi..."              | ![Tiến sĩ giấy](./images/tien_si_giay.png)     |                    |

### 3.2. Nhóm tinh anh (Epic)

| Tên nhân vật            | Visual concept                                                                                    | Animation                                                                         | Audio specs                                                      | Hình ảnh mô phỏng                                        | Ghi chú            |
| :---------------------- | :------------------------------------------------------------------------------------------------ | :-------------------------------------------------------------------------------- | :--------------------------------------------------------------- | :------------------------------------------------------- | :----------------- |
| **Tổ trưởng dân phố**   | Ông già nghiêm túc, đeo băng đỏ "Tổ trưởng" tay trái, cầm loa phường mini. Áo sơ mi trắng sơ vin. | Hét vào loa tạo sóng âm đẩy lùi địch.                                             | **Skill:** "Đề nghị giữ trật tự!", "Alo 1 2 3 4"                 | ![Tổ trưởng dân phố](./images/to_truong_dan_pho.png)     | Làm trước bản demo |
| **Thợ cắt tóc**         | Thanh niên tóc nhuộm màu mè, mặc áo gile đen, cầm kéo và lược, hông đeo bao da đựng đồ nghề.      | Múa kéo xoay vòng vòng. Skill: Lao tới cắt liên tục tạo vệt sáng.                 | **Atk:** Tiếng kéo "Cắt cắt" <br/> **Skill:** "Tóc này mốt lắm!" | ![Thợ cắt tóc](./images/tho_cat_toc.png)                 | Làm trước bản demo |
...
| Tên nhân vật         | Visual concept                                                                               | Animation                                                    | Audio specs                                                            | Hình ảnh mô phỏng                                  | Ghi chú            |
| :------------------- | :------------------------------------------------------------------------------------------- | :----------------------------------------------------------- | :--------------------------------------------------------------------- | :------------------------------------------------- | :----------------- |
| **Chú Ba xe ôm**     | Đội mũ cối, mặc áo sờn vai, đi dép lào. Ngồi trên xe Dream (kể cả khi không di chuyển).      | Lao xe húc vào địch. Idle: Lấy khăn lau xe.                  | **Atk:** Tiếng pô xe "Bạch bạch" <br/> **Idle:** "Đi đâu em ơi?"       | ![Chú Ba xe ôm](./images/chu_ba_xe_om.png)         | Làm trước bản demo |
| **Cô Tư bán nước**   | Mặc đồ bộ hoa, ngồi ghế nhựa đỏ, cầm quạt nan phe phẩy. Bàn nước di động bên cạnh.           | Ném cốc trà đá. Skill: Rót trà mời cả team uống.             | **Skill:** "Uống gì con ơi?", "Trà đá miễn phí"                        | ![Cô Tư bán nước](./images/co_tu_ban_nuoc.png)     | Làm trước bản demo |
...
| Tên nhân vật       | Visual concept                                                       | Animation                      | Audio specs                        | Hình ảnh mô phỏng   | Ghi chú            |
| :----------------- | :------------------------------------------------------------------- | :----------------------------- | :--------------------------------- | :------------------ | :----------------- |
| **Chị tạp vụ**     | Quấn khăn trùm đầu, xách xô nước và cầm cây lau nhà.                 | Lau sàn đẩy địch lùi lại.      | **Voice:** "Dơ quá đi mất"         | <img width="200" /> | Làm trước bản demo |
| **Anh Grab Food**  | Mặc áo xanh lá cây, đội mũ bảo hiểm 3/4. Cầm túi đồ ăn.              | Ném túi đồ ăn.                 | **Voice:** "Đơn hàng tới rồi"      | <img width="200" /> | Làm trước bản demo |
...
| Tên nhân vật        | Visual concept                                        | Animation                        | Audio specs                             | Hình ảnh mô phỏng   | Ghi chú            |
| :------------------ | :---------------------------------------------------- | :------------------------------- | :-------------------------------------- | :------------------ | :----------------- |
| **Bé Tí bắn bi**    | Trẻ con, đeo khăn quàng đỏ, quần đùi xanh, cầm bi ve. | Búng bi (tay làm động tác búng). | **SFX:** Tiếng bi "Cạch cạch"           | <img width="200" /> | Làm trước bản demo |
| **Chú Tư xe thồ**   | Đi xe đạp thồ cũ kỹ, thồ bao tải to phía sau.         | Húc xe đạp chậm chạp.            | **SFX:** "Kính coong"                   | <img width="200" /> | Làm trước bản demo |
...
| **Cậu Vàng**        | Chó cỏ màu vàng, đeo xích cổ, đuôi vẩy tít mù.        | Cắn và sủa.                      | **SFX:** "Gâu gâu!", "Ẳng ẳng"          | <img width="200" /> |                    |
