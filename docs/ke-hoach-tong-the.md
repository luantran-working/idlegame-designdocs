...
## 9. Lộ trình thực thi chi tiết (Execution roadmap)

Phần này mô tả lộ trình thực thi dự án theo mô hình các khối chức năng (work blocks).

### 9.1. Nguyên tắc thực thi
...
### 9.2. Tổng quan các khối công việc
...
### 9.3. Block A: Nền móng và core gameplay
...
### 9.8. Biểu đồ Gantt lộ trình phát triển
